...
> In the world of cybersecurity, if you don't succeed in the first try, just call it version 1.0 and move on!
...
All in all, having a plan of action and a system of organization goes a long way. A few might agree even say it’s the <u>only correct way to pentest</u>.
...
2. Make a consolidated sheet of commands where you can quickly find a command that you might have forgotten . This is useful for creating a cheatsheet.
3. Create a step-by-step guide of a procedure that you’re not sure you’ll remember after 6 months.
